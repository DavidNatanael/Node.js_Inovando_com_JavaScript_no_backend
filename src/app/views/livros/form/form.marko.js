// Compiled using marko@4.16.11 - DO NOT EDIT
"use strict";
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" placeholder=\"coloque o titulo\"" +
    marko_attr("value", "" + data.livro.titulo) +
    "></div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" placeholder=\"150.25\"" +
